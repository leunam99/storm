...
int main(int argc, char const *argv[]) {
    ...
    emdp.addStateLabel("label222", 1);
    emdp.addStateLabel("label3", 1);

    emdp.addActionLabel("act1",1,2);
    emdp.addActionLabel("act12342sd",1,2);
    emdp.addActionLabel("act2",1,2);

    emdp.addVisits(1,2,3,405);
    emdp.addVisits(1,2,10,77);
    emdp.addVisits(2,3,4,33);
